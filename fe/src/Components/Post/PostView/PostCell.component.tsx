const PostCellComponent = () => {
  return (
    <div className="w-64">
      <img className="box object-cover w-64 h-40" src="https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg?cs=srgb&dl=pexels-pixabay-45201.jpg&fm=jpg" alt="blog_post_image" />
      <div>
